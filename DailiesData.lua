...
dllocal_group = {
    --TBC 
    [11665] = { group = "TBC Fishing";      expac=2},		[11666] = { group = "TBC Fishing";      expac=2},
    ...
    [11342] = { expac=2;  group = "Horde PvP";        faction="Horde"},
     ...
     [13833] = { group = "Wrath Fishing",     expac=3},		[13834] = { group = "Wrath Fishing",     expac=3},
     [13836] = { group = "Wrath Fishing",     expac=3},

     [13100] = { group = "Wrath Cooking";       faction="Alliance",     expac=3},
     [13101] = { group = "Wrath Cooking";       faction="Alliance",     expac=3},
     [13102] = { group = "Wrath Cooking";       faction="Alliance",     expac=3},
     [13103] = { group = "Wrath Cooking";       faction="Alliance",     expac=3},
     [13107] = { group = "Wrath Cooking";       faction="Alliance",     expac=3},

     [13112] = { group = "Wrath Cooking";       faction="Horde",     expac=3},
     [13113] = { group = "Wrath Cooking";       faction="Horde",     expac=3},
     [13114] = { group = "Wrath Cooking";       faction="Horde",     expac=3},
     [13115] = { group = "Wrath Cooking";       faction="Horde",     expac=3},
     [13116] = { group = "Wrath Cooking";       faction="Horde",     expac=3},

     [12958] = { group = "Jewelcrafting";       expac=3},
     [12959] = { group = "Jewelcrafting";       expac=3},
     [12960] = { group = "Jewelcrafting";       expac=3},
     [12961] = { group = "Jewelcrafting";       expac=3},
    ...
    [13250] = { group = "Wrath Heroic";   expac=3,    short = "Gun", 	long = "Gundrak" },	
    [13253] = { group = "Wrath Heroic";   expac=3,    short = "HoL", 	long = "Halls of Lightning" },	
    [13252] = { group = "Wrath Heroic";   expac=3,    short = "HoS", 	long = "Halls of Stone" },	
    [13251] = { group = "Wrath Heroic";   expac=3,    short = "CoS", 	long = "The Culling of Stratholme" },	
    [13246] = { group = "Wrath Heroic";   expac=3,    short = "Nex", 	long = "The Nexus" },	
    [13247] = { group = "Wrath Heroic";   expac=3,    short = "Oc", 	long = "The Oculus" },	
...
-- group of quests that you can only do one of.
-- you might be able to grab several, but can't complete them all the same day
-- for example the Netherwing gathering quests
dllocal_exclu = {
	[11101] = { group = "NW Deadliest trap"},
	[11097] = { group = "NW Deadliest trap"},

	[11016] = { group = "NW Gathering" },
	[11017] = { group = "NW Gathering" },
	[11018] = { group = "NW Gathering" },
}


-- group of quests that get replaced after some time
-- Typically the SSO phase quests
-- Both quests seem to become 'completed' together, when in reality only the one that is available in that phase can
dllocal_temp = {
	[11496] = 11523,    -- SSO Wards
	[11524] = 11525,    -- SSO Conversions
    [11538] = 11537,    -- SSO armory battle
    [11532] = 11533,    -- SSO air strike
    [11513] = 11514,    -- SSO portal
    [11542] = 11543,    -- SSO burn boats
    [11539] = 11540,    -- SSO harbor
    [11520] = 11521,    -- SSO roots
    [11535] = 11536,    -- SSO Bsmith
}


dllocal_reps = {
	[11008] = { [1031] = 350 },
	[11023] = { [1031] = 500, 	[1038] = 500 },
	[11051] = { [1038] = 350 },
	[11066] = { [1031] = 350, 	[1038] = 350 },
	[11080] = { [1038] = 350 },
	...
	[11085] = { [1031] = 350 },
	[11354] = { [933]  = 350,	[946]  = 350,	[947] = 350},
	[11362] = { [933]  = 350,	[946]  = 350, 	[947] = 350},
	[11363] = { [933]  = 350,	[946]  = 350, 	[947] = 350},
	[11364] = { [933]  = 250,	[946]  = 250,	[947] = 250	},
	[11368] = { [933]  = 350,	[942]  = 350 },
	[11369] = { [933]  = 350,	[942]  = 350 },
	[11370] = { [933]  = 350,	[942]  = 350 },
	[11371] = { [933]  = 250,	[942]  = 250 },
	[11372] = { [933]  = 350,	[1011] = 350 },
	[11373] = { [933]  = 500 },
	[11374] = { [933]  = 350,	[1011] = 350 },
	[11375] = { [933]  = 350,	[1011] = 350 },
	[11376] = { [933]  = 250,	[1011] = 250 },
	[11378] = { [933]  = 350,	[989]  = 350 },
	[11382] = { [933]  = 350,	[989]  = 350 },
	[11383] = { [933]  = 250,	[989]  = 250 },
	[11384] = { [933]  = 350,	[935]  = 350 },
	[11385] = { [933]  = 250,	[935]  = 250 },
	[11386] = { [933]  = 350,	[935]  = 350 },
	[11387] = { [933]  = 250,	[935]  = 250 },
	[11388] = { [933]  = 350,	[935]  = 350 },
	[11389] = { [933]  = 250,	[935]  = 250 },
	[11499] = { [933]  = 250,	[1077] = 250 },
	[11500] = { [933]  = 250,	[1077] = 250 },

    --SSO
    -- phase 1
    [11496] = { [1077] = 150 }, -- SSO phase 1
    [11524] = { [1077] = 150 }, -- SSO phase 1

    -- phase 2
    [11538] = { [1077] = 250 }, -- SSO phase 2
    [11523] = { [1077] = 150 }, -- SSO phase 2
    [11525] = { [1077] = 150 }, -- SSO phase 2
    [11532] = { [1077] = 150 }, -- SSO phase 2

    --phase 3
    [11537] = { [1077] = 250 }, -- SSO Phase 3
    [11542] = { [1077] = 250 }, -- SSO Phase 3
    [11513] = { [1077] = 250 }, -- SSO phase 2
    [11539] = { [1077] = 250 }, -- SSO Phase 3
    [11533] = { [1077] = 150 }, -- SSO phase 3
    [11514] = { [1077] = 250 }, -- SSO phase 3

    --phase 4
    [11543] = { [1077] = 250 }, -- SSO Phase 4
    [11540] = { [1077] = 250 }, -- SSO Phase 4
    [11544] = { [1077] = 350 },
    [11520] = { [1077] = 350 },
    [11521] = { [1077] = 350 },
    [11541] = { [1077] = 250 },
...
dllocal_repicons = {
	[933]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\inv_qiraj_jewelencased',						-- Consortium
	[935]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\inv_shield_30',									-- Sha'tar
	[942]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\ability_racial_ultravision',					-- Cenarion
	[946]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\spell_misc_hellifrepvphonorholdfavor',			-- Honor Hold
	[947]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\inv_misc_token_thrallmar',						-- Thrallmar
	[989]  = 'Interface\\AddOns\\Dailies\\Images\\reps\\spell_holy_borrowedtime',						-- Keepers of Time
	[1011] = 'Interface\\AddOns\\Dailies\\Images\\reps\\inv_feather_06',								-- Lower City
	[1015] = 'Interface\\AddOns\\Dailies\\Images\\reps\\inv_netherwhelp',								-- Netherwing
...
dllocal_attuneId = {
    ...
    [11368] = 106,  -- CE Heroics
	[11369] = 106,
    [11370] = 106,
	
    [11378] = 109,  -- KoT Heroics
    [11382] = 109, 
	
    [11384] = 108,  -- Sha'tar Heroics
    [11386] = 108,
	[11388] = 108,
    
    [11372] = 107,  -- LC Heroics
    [11373] = 107,
	[11374] = 107,
    [11375] = 107,
	
	[11354] = { Horde = 104, Alliance = 105 },	-- Thrallmar / HH
    [11362] = { Horde = 104, Alliance = 105 },
	[11363] = { Horde = 104, Alliance = 105 },
